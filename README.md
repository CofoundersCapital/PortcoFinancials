...
- The Drive watcher records classified Drive files in `Drive Classification Registry` and skips the LLM on later watcher runs unless the file fingerprint or required-doc checklist changes.
